...
const GetAlquilerFechaInicioFinal = async (inicio, fin) => {
  const client = await mongoConn();
  try {
    const fecha_inicio = new Date(inicio);
...
export { GetAllActivo, GetId, pay , GetAlquilerFecha , GetCantidad , GetAlquilerFechaInicioFinal };
