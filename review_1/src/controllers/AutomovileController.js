import { GetAllDisp , GetCantidad, GetAllCap5 , GetMarca ,  GetAllCanSucursal , GetCapDisp } from "../models/automoviles.js";
...
const GetCapacidadDisponible = async (req, res) => {
    try {
        
        const result = await GetCapDisp();
...
export { GetAllAutoDisp , GetSucursalCantidad, GetAllCapacidad5 , GetObderbyMarca , GetAllCantidadSucursal , GetCapacidadDisponible};